...
Forall ?offer ?product ?vendor ?price ?from ?to ?delivery ?webpage(
    ...
    Then ?product [bsbm_voc:offerPrice -> ?price] )
		...
		Setting the sliding window size to five seconds, \reffig{all-systems-memory-consumption} shows the amount of memory used by the three engines during the life time of the BSBM rule.
