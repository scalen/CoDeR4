\begin{nestedsection}{R4: Rule-based Reasoning over RDF streams using Rete}{implementation}
	...
	We also added a simple extension to RIF-Core to enable users to specify window constraints as part of their rules, as shown in \reffig{lst-S-RIF-Core}.
	...
	\begin{nestedsection}{Continuous Reasoning}{implementation: continuous reasoning}
		...
		As such, the interpretation of beta nodes in R4 is an implementation of the window-join operator characterised as a pair of SteMs implicitly unioned by contribution to the same stream, as shown in \reffig{continuous datalog: SteM}.
