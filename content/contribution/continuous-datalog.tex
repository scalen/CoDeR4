...
\rangle$. As previously shown in \refdef{continuous datalog: ta
  datalog program}, this may then be further reduced to the Datalog
...
\]
\noindent where $J^T$ is a justification for the entailment of x by $\Pi^{WC}_i$.
