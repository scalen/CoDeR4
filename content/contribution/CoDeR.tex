\begin{nestedsection}{CoDeR Model for Continuous Deductive Reasoning}{model}
	...
	\begin{nestedsection}{Data Model}{model: data}
		...
		\reffig{intersected-intervals} provides an example of this for some ${\Pi^C = \langle \{c\,\text{:-}\,a,b\,.\},\{\},(\{a\}|1,\{b\}|2),3\}}$ over instants ${i = 1 \dots 4}$.
		\begin{figure}
			\centering
	...
	\begin{nestedsection}{Minimal Algebra}{model: algebra}
		...
		For example, \refeqn{basic-example-plan} is a plan expressed in the CoDeR algebra for the ${\Pi^C = \{ \{b\,\text{:-}\,a.\}, \{\}, S, r \}}$, where $a$ and $b$ are RDF triples.
