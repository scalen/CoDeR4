	...
	\begin{nestedsection}{Minimal Algebra}{model: algebra}
		...
		\begin{description}
			\item[$\sigma_{triple}\,S$] \hfill \\
				...
				\begin{figure}[t]
					\centering
					\includegraphics[width=0.45\textwidth]{basic-pattern-match}
			...
			\item[$\sigma_{external}\,S$] \hfill \\
				\begin{figure}[b]
					\centering
					\includegraphics[width=0.45\textwidth]{datatype-function}
			...
			\item[${{}_g{\pi_t}\,S}$] \hfill \\
				\begin{figure}[t]
					\centering
					\includegraphics[width=0.45\textwidth]{graph-to-triple}
			...
			\item[$\text{:-}_{head}\,S$] \hfill \\
				\begin{figure}[b]
					\centering
					\includegraphics[width=0.45\textwidth]{instance-implication}
